...
All code for the content repository is licensed under the [AGPL license]([https://github.com/space-wizards/space-station-14/blob/master/LICENSE.TXT](https://github.com/Coloss260/Flagship/blob/master/LICENSE)).
